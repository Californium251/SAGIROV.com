...
CSRF_TRUSTED_ORIGINS = csrf_trusted_origins.split(',') if cors_allowed_origins else ['http://localhost:3000', 'https://sagirovcom-production.up.railway.app', 'https://foolish-price-production.up.railway.app']
